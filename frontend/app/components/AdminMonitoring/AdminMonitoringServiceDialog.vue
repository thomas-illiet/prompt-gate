...
<template>
  <AppDialogCard v-model="isOpen" icon="mdi-heart-pulse" :loading="props.loading" max-width="640" subtitle="Monitor an HTTP endpoint and define the response that counts as healthy." :title="title">
