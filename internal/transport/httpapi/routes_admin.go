...
func adminUserRoutes(handler *admin.Handler) []routeDefinition {
	return []routeDefinition{
		...
		{pattern: "GET /api/v1/admin/users/{id}/ips", handler: handler.HandleAdminListUserIPAddresses},
...
func adminServiceAccountRoutes(handler *admin.Handler) []routeDefinition {
	return []routeDefinition{
		...
		{pattern: "GET /api/v1/admin/service-accounts/{id}/ips", handler: handler.HandleAdminListServiceAccountIPAddresses},
